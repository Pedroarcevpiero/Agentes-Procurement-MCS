...
🟢 **HECHO VERIFICADO (actualizado tras verificación de QA, 2026-07-01) — cifra de "25,000 agentes de IA" rastreada a su fuente primaria.** El CEO de McKinsey, **Bob Sternfels**, declaró que la firma "añadió 25,000 agentes de IA a su plantilla en menos de dos años". Lo dijo primero en el **Consumer Electronics Show (CES) de Las Vegas, en enero de 2026**, y lo desarrolló después en un episodio del podcast **IdeaCast de Harvard Business Review**. Cifras asociadas declaradas por Sternfels: la firma opera con ~60,000 "trabajadores" = 40,000 empleados humanos + ~25,000 agentes de IA; la meta es que cada uno de los 40,000 empleados humanos esté "habilitado por al menos uno o más agentes" dentro del próximo año y medio; las iniciativas de IA representan ~40% del trabajo de McKinsey; ~25% de los honorarios globales provienen ya de precios basados en resultados (outcomes-based pricing).
Fuentes: Varanasi, L. (2026-02-13). Artículo de Business Insider (sindicado vía Yahoo Finance: "McKinsey says it has 25,000 AI agents...", consultado 2026-07-01), https://finance.yahoo.com/news/mckinsey-says-25-000-ai-103101624.html ; "McKinsey CEO Bob Sternfels says the firm now has 60,000 employees: 25,000 of them are AI agents", The Money Times, 2026-01-13 (consultado 2026-07-01), https://themoneytimes.media/2026/01/13/mckinsey-ceo-bob-sternfels-says-the-firm-now-has-60-000-employees-25-000-of-them-are-ai-agents/ ; cobertura adicional en AOL (consultado 2026-07-01), https://www.aol.com/articles/ceo-bob-sternfels-says-mckinsey-104101693.html
**Nota de cautela:** la declaración es del propio CEO (afirmación del vendor sobre cifras internas, no auditada externamente), pero la ATRIBUCIÓN está verificada con múltiples medios establecidos, evento y fechas concretos. La variante "20,000 agentes junto a 40,000 consultores" que circulaba en blogs de seguridad parece ser una versión imprecisa de esta misma declaración — usar la cifra de 25,000 con la atribución de CES enero 2026.
...
**Cifras de escala de Wave — CORREGIDAS tras re-verificación de QA (2026-07-01):**

⚠️ **NO VERIFICABLE — cifra retirada.** La afirmación inicialmente recogida de que "Wave ha rastreado más de 340,000 iniciativas en más de 1,000 organizaciones, reflejando más de $200 mil millones USD en gasto" NO pudo confirmarse contra ninguna fuente en la re-verificación dedicada (la página oficial de Wave muestra sus contadores dinámicos como ceros de placeholder en el fetch, y las búsquedas dirigidas con esas cifras exactas no devolvieron ninguna fuente que las respalde). **Tratar estas cifras como no verificables; no usarlas en la redacción final.**

🟢 **HECHO VERIFICADO — cifras de escala que SÍ se confirmaron en la re-verificación:**
- Wave aprovecha una base de conocimiento de **más de 500,000 iniciativas** (descrita por McKinsey como "la mayor base de conocimiento del mundo" de iniciativas de transformación) junto con los "custom AI agents" de Wave para identificar oportunidades, apoyar la planeación, predecir riesgos y acelerar decisiones.
  Fuente: "Wave Program Management Software", McKinsey & Company (consultado 2026-07-01), https://www.mckinsey.com/capabilities/transformation/how-we-help-clients/wave/overview
- En el sector oil & gas, Wave ha gestionado **más de $47 mil millones USD en impacto de negocio en más de 80 clientes**, incluyendo siete de los diez mayores productores del mundo.
  Fuente: páginas de impacto de Wave, McKinsey & Company (consultado 2026-07-01, vía resultados de búsqueda sobre páginas oficiales de mckinsey.com/capabilities/transformation/how-we-help-clients/wave/)
- En el caso de procurement documentado por McKinsey, un programa comenzó con 700 iniciativas y se expandió a más de 1,200 en 12 meses.
  Fuente: "Procurement transformation program to reduce spend by $1 billion", McKinsey & Company (consultado 2026-07-01), https://www.mckinsey.com/capabilities/transformation/how-we-help-clients/wave/our-impact/procurement-transformation-program-to-reduce-spend-by-1-billion
- Vía el módulo "Integrated Impact Management" (parte de Spendscape, integrado con Wave — ver sección 3.1), clientes han gestionado ahorros por valor de $1,000 millones USD.
  Fuente: "Procurement Savings Tracking Software", McKinsey & Company / Spendscape (consultado 2026-07-01), https://www.mckinsey.com/capabilities/operations/tech-tools/spendscape-technology/our-offerings/savings-tracking-and-integrated-impact-management
