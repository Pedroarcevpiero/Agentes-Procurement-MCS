...
|---|---|---|---|
| Eficiencia potencial de la función procurement con agentic AI | "25 a 40 por ciento más eficiente" | A, B (repetida en ambos) | AFIRMACIÓN DEL VENDOR (proyección, no medición real) |
| Eficiencia de "autonomous category agents" | "15 to 30 percent efficiency improvements" (automatización de actividades sin valor añadido) | A (vía WebSearch) | AFIRMACIÓN DEL VENDOR |
...
| Ahorro por gestión de tail spend CON agentes de IA | "10% a 15%" | A | AFIRMACIÓN DEL VENDOR — mismo rango que caso telco (2.2); posible mismo dato reciclado |
